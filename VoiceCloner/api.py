...
from VoiceCloner.models.classifier import AudioMiniEncoderWithClassifierHead
from VoiceCloner.models.diffusion_decoder import DiffusionTts
from VoiceCloner.models.autoregressive import UnifiedVoice
from tqdm import tqdm

from VoiceCloner.models.arch_util import TorchMelSpectrogram
from VoiceCloner.models.clvp import CLVP
from VoiceCloner.models.cvvp import CVVP
from VoiceCloner.models.random_latent_generator import RandomLatentConverter
from VoiceCloner.models.vocoder import UnivNetGenerator
from VoiceCloner.utils.audio import wav_to_univnet_mel, denormalize_tacotron_mel
from VoiceCloner.utils.diffusion import SpacedDiffusion, space_timesteps, get_named_beta_schedule
from VoiceCloner.utils.tokenizer import VoiceBpeTokenizer
from VoiceCloner.utils.wav2vec_alignment import Wav2VecAlignment

pbar = None

DEFAULT_MODELS_DIR = os.path.join(os.path.expanduser('~'), '.cache', 'VoiceCloner', 'models')
MODELS_DIR = os.environ.get('VoiceCloner_MODELS_DIR', DEFAULT_MODELS_DIR)
MODELS = {
    'autoregressive.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/autoregressive.pth',
    'classifier.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/classifier.pth',
    'clvp2.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/clvp2.pth',
    'cvvp.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/cvvp.pth',
    'diffusion_decoder.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/diffusion_decoder.pth',
    'vocoder.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/vocoder.pth',
    'rlg_auto.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/rlg_auto.pth',
    'rlg_diffuser.pth': 'https://huggingface.co/jbetker/VoiceCloner-tts-v2/resolve/main/.models/rlg_diffuser.pth',
}

def download_models(specific_models=None):
    """
    Call to download all the models that VoiceCloner uses.
    """
...
def classify_audio_clip(clip):
    """
    Returns whether or not VoiceCloners' classifier thinks the given clip came from VoiceCloner.
    :param clip: torch tensor containing audio waveform data (get it from load_audio)
    :return: True if the clip was classified as coming from VoiceCloner and false if it was classified as real.
    """
...
class TextToSpeech:
    """
    Main entry point into VoiceCloner.
    """
    ...
    def tts(self, text, voice_samples=None, conditioning_latents=None, k=1, verbose=True, use_deterministic_seed=None,
        ...
        :param k: The number of returned clips. The most likely (as determined by VoiceCloners' CLVP model) clips are returned.
        ...
        :param num_autoregressive_samples: Number of samples taken from the autoregressive model, all of which are filtered using CLVP.
               As VoiceCloner is a probabilistic model, more samples means a higher probability of creating something "great".
    ...
    def deterministic_state(self, seed=None):
        """
        Sets the random seeds that VoiceCloner uses to the current time() and returns that seed so results can be
        reproduced.
        """
