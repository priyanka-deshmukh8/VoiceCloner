...
if __name__ == '__main__':
    ...
    parser.add_argument('--textfile', type=str, help='A file containing the text to read.', default="VoiceCloner/data/riding_hood.txt")
    ...
    parser.add_argument('--model_dir', type=str, help='Where to find pretrained model checkpoints. VoiceCloner automatically downloads these to .models, so this'
